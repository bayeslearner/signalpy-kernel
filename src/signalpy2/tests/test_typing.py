...
dependency-free. Run it with:
    ...
    uv run --with pyright --with pytest pytest src/signalpy2/tests/test_typing.py
"""
...
from signalpy2.examples.typed_plugin import ReporterDeps, reporter
...
def test_the_shipped_example_typechecks():
    import signalpy2.examples.typed_plugin as module
