...
**Simplicity over compatibility.** No shims, no dual paths. `signalpy` was
deleted rather than deprecated because it had no users.
...
pins and vendors it. Its documentation is preserved at
`docs/history/2026-08-v1-book/`; its design notes at
`docs/history/2026-04-design-notes/`.
